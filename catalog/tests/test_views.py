...
class LoanedBookUserListViewTest(TestCase):
    def setUp(self):
        # create two users
        ...
        for book_copy in range(number_of_book_copies):
            ...
            the_borrower = test_user_one if book_copy % 2 else test_user_two
            status = 'm'
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Confirm all books belong to testuserone and are on loan
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        # confirm that just 5 of the items are displayed due to pagination
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(
            reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}),
            {'due_back': valid_future_date}, follow=True
            )
        self.assertTrue(response, reverse('all-borrowed'))
